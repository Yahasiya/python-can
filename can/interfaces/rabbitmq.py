...
class RabbitmqBus(BusABC):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self.channel_info = f"RabbitMq bus channel {self.channel_id}"
    ...
    def _recv_internal(
        ...
        try:
            ...
            channel.basic_consume(queue=queue.method.queue, on_message_callback=arbcallback, auto_ack=True)
    ...
    def send(self, msg: Message, timeout: Optional[float] = None) -> None:
        ...
        msg_copy.is_rx =  False    #bus_queue is not self.queue
        #    try:
        ...
        result=json.dumps(msg_copy,cls=CustomEncoder)
        print(result)
